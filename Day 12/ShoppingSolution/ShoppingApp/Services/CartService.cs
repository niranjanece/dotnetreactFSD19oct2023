...
namespace ShoppingApp.Services
{
    public class CartService : ICartService
    {
        ...
        {
            var cart = _cartRepository.GetAll().FirstOrDefault(c => c.Username == cartDTO.Username);
            bool cartItem = CheckIfCartItemAlreadyPresent(cart.cartNumber,cartDTO.ProductId);    
            if (cartItem)
            {
