...
insert into Departments(dept_name, floor, phone, emp_no) values
('Management' , 5, '34' , 1)
insert into Departments(dept_name, floor, phone, emp_no) values
('Books' , 1, '81' , 4),
('Clothes', 2, '24' , 4),
...
insert into Items(item_name,item_type,item_color) values
...
('Sextant','N','--'),
('Map Measure','N','--'),
('Boots-snake proof','C','Green'),	('Pith Helmet','C','Khaki'),
...
insert into Sales(sales_no,saleqty,item_name,dept_name) values
...
(115,1,'Sextant','Clothes'),
(116,1,'Pocket Knife-Nile','Equipment')
